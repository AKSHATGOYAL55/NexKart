...
const FilterContent = ({
  ...
  <>
    <div className="flex items-center justify-between mb-4">
      <h2 className="font-semibold text-gray-900 hidden lg:block">Filters</h2>
      {hasActiveFilters && (
        <button
...
const Products = () => {
  ...
  const hasActiveFilters = urlKeyword || category || minPrice || maxPrice;
        ...
        {totalProducts > 0 && (
          <p className="text-gray-500 text-xs sm:text-sm mt-0.5">
            ...
            {urlKeyword && (
              <span className="ml-1">
                for "
                <span className="font-medium text-gray-700">{urlKeyword}</span>"
              </span>
            )}
          </p>
        )}
          ...
          {error && !isLoading && (
            <div className="flex flex-col items-center justify-center py-20 gap-4">
              ...
              <p className="text-gray-400 text-sm text-center max-w-xs">
                The server might be starting up. Please wait a moment.
              </p>
              <button
                onClick={() => refetch()}
